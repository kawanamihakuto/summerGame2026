...
Matrix4x4::Matrix4x4(const MATRIX& mat) :
	...
	m30(mat.m[0][3]), m31(mat.m[1][3]), m32(mat.m[2][3]), m33(mat.m[3][3])
{
}
...
{
	float x = Vector3(m00, m10, m20).Length();
	float y = Vector3(m01, m11, m21).Length();
	float z = Vector3(m02, m12, m22).Length();
